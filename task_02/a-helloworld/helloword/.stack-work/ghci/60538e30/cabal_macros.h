...
/* package helloword-0.1.0.0 */
#ifndef VERSION_helloword
#define VERSION_helloword "0.1.0.0"
#endif /* VERSION_helloword */
#ifndef MIN_VERSION_helloword
#define MIN_VERSION_helloword(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_helloword */
...
#define CURRENT_COMPONENT_ID "helloword-0.1.0.0-Gnobh2TCMkeHvhy3oiCCsj-helloword"
